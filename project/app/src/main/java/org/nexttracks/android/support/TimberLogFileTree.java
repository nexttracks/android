    ...
    @SuppressLint("LogNotTimber")
        ...
        public TimberLogFileTree(Context context) {
            ...
            try {
                ...
                File direct = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS) + "/nexttracks_debug");
                ...
                file = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS) + "/nexttracks_debug" + File.separator + fileName);
                if (!file.exists()) {
                    file.createNewFile();
                }
